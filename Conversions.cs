    ...
    public static class Conversions
    {
        ...
        public static int ToArabicInternal(string roman, int last = 1000)
        {
            return roman switch
            {
                ...
                var temp when (temp.Length >= 2 && temp[0..2] == "CM" && last == 1000) => 900 + ToArabicInternal(temp.Substring(2), 900),
                var temp when (temp[0] == 'M' && last == 1000) => 1000 + ToArabicInternal(temp.Substring(1), 1000),
                var temp when (temp.Length >= 2 && temp[0..2] == "CD" && last == 1000) => 400 + ToArabicInternal(temp.Substring(2), 400),
                var temp when (temp[0] == 'D' && last == 1000) => 500 + ToArabicInternal(temp.Substring(1), 500),
                var temp when (temp.Length >= 2 && temp[0..2] == "XC" && last >= 100) => 90 + ToArabicInternal(temp.Substring(2), 90),
                var temp when (temp[0] == 'C' && last >= 100 && last != 400 && last != 900) => 100 + ToArabicInternal(temp.Substring(1), 100),
                var temp when (temp.Length >= 2 && temp[0..2] == "XL" && last >= 100) => 40 + ToArabicInternal(temp.Substring(2), 40),
                var temp when (temp[0] == 'L' && last >= 100) => 50 + ToArabicInternal(temp.Substring(1), 50),
                var temp when (temp.Length >= 2 && temp[0..2] == "IX" && last >= 10) => 9 + ToArabicInternal(temp.Substring(2), 9),
                var temp when (temp[0] == 'X' && last >= 10 && last != 40 && last != 90) => 10 + ToArabicInternal(temp.Substring(1), 10),
                var temp when (temp.Length >= 2 && temp[0..2] == "IV" && last >= 10) => 4 + ToArabicInternal(temp.Substring(2), 4),
                var temp when (temp[0] == 'V' && last >= 10) => 5 + ToArabicInternal(temp.Substring(1), 5),
                var temp when (temp[0] == 'I' && last >= 1 && last != 4 && last != 9) => 1 + ToArabicInternal(temp.Substring(1), 1),
                "N" => 0,
